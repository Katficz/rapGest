...
router.get('/raporty/moj-raport/zestawienie', auth.authTech, raportController.raport_GET_firstSection)

//GET for this users + shifts failures
router.get('/raporty/moj-raport/awarie', auth.authTech, raportController.raport_GET_failures)
